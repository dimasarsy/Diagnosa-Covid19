  ...
  <tr> <th align="left"> Identitas Pasien </th>
		<th align="left"> Gejala Pasien </th> 
				...
				<tr>
					...
					$query_pasien=mysqli_query($koneksi, "SELECT * FROM diagnosa,pasien where  diagnosa.id_pasien='$id_pasien' AND diagnosa.id_pasien=pasien.id_pasien order by diagnosa.id_pasien");
				...
				<?php
					include "koneksi.php";
							...
							while($row_gejala_input2=mysqli_fetch_array($query_gejala_input2)){
								$nogejala2++;
								echo "<li style='list-style:none; font-size:9pt;'><img src='../img/checkbox.jpg' height='20'><strong>".$row_gejala_input2['kd_penyakit']."|".$row_gejala_input2['nama_penyakit']."|solusi:".$row_gejala_input2['solusi']."</strong></li>";
								}
					?>
...
<br>
<center><a href="#" class="no-print" onclick="window.print();">Cetak/Simpan PDF</a>  <a class="no-print" href="halaman_admin.php?top=datadiagnosa.php" >|  Kembali</a></center> 
