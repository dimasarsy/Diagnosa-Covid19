...
<head>
  ...
  <title>Dokter | Dokter Penyakit Dalam</title>
              ...
              <div class="row d_flex grid">
                 <div class="col-md-7">
                    <div class="coronata_img text_align_center">
                       <figure><img src="../img/dokter_dalam.png" style="width:700px"data-aos="fade-right" data-aos-duration="120"></figure>
                    </div>
                 </div>

                 <div class="col-md-5 oder1">
                    <div class="titlepage text_align_right">
                       <h2 style="color: #066B01;"  data-aos="fade-left" data-aos-duration="100">DOKTER SPESIALIS PENYAKIT DALAM</h2>
                       <p data-aos="fade-left"  data-aos-duration="90">Dokter penyakit dalam disebut juga internis dengan gelar SpPD. Tugas utamanya adalah mendiagnosis, mencegah, dan mengobati penyakit akut maupun kronis pada orang dewasa dan lansia, melalui pemberian obat-obatan atau tindakan nonbedah.
                       </p>
        ...
        <div class="row">
          <?php
            include "koneksi.php";
              ...
              $sql = "SELECT user.iduser, user.nama, dokter.lahir, dokter.tgl_lahir,dokter.kelamin, dokter.praktek FROM user INNER JOIN dokter ON user.iduser = dokter.iduser where user.level='dokterdalam' order by user.iduser";
