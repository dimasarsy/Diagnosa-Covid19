...
<head>
<meta charset="utf-8">
<title>Diagnosa | Form Diagnosa</title>
								...
								<div class="modal-dialog">
									<div class="modal-content">
										...
										<div class="modal-body">
														<form  method="post" name="form" target="_self" action="konsultasi_periksa.php">
														  <table width="700" border="0" align="center" cellpadding="2" cellspacing="1" bordercolor="#FFFFFF">
															...
															<?php
															include "koneksi.php";
															$query=mysqli_query($koneksi,"SELECT * FROM gejala order by kd_gejala asc") or die("Query Error..!" .mysqli_error);
														...
														<div class="modal-footer">  
																		  ...
																		  <button type="button" class="btn btn-default" onclick="location.href='halaman_operator.php?top=datadiagnosa.php'">Batal</button>
														</div>
																</form>	
