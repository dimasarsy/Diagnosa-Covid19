...
<head>
  ...
  <title>Dokter | Dokter Umum</title>
              ...
              <div class="row d_flex grid">
                 <div class="col-md-7">
                    <div class="coronata_img text_align_center">
                       <figure><img src="../img/dokter_umum2.png" style="width:700px" data-aos="fade-right" data-aos-duration="120"></figure>
                    </div>
                 </div>

                 <div class="col-md-5 oder1">
                    <div class="titlepage text_align_right">
                       <h2 style="color: #003F7D" data-aos="fade-left" data-aos-duration="100">DOKTER UMUM</h2>
                       <p data-aos="fade-left"  data-aos-duration="90">Dokter umum adalah tenaga medis yang diperkenankan untuk melakukan praktik medis tanpa harus spesifik memiliki spesialisasi tertentu, hal ini memungkinkannya untuk memeriksa masalah-masalah kesehatan pasien secara umum untuk segala usia. Dokter umum juga biasa disebut sebagai dokter keluarga.
                       </p>
        ...
        <div class="row">
          <?php
            include "koneksi.php";
              ...
              $sql = "SELECT user.iduser, user.nama, dokter.lahir, dokter.tgl_lahir,dokter.kelamin, dokter.praktek FROM user INNER JOIN dokter ON user.iduser = dokter.iduser where user.level='dokterumum' order by user.iduser";
