...
echo $text;
//$kosongtabel=mysqli_query($koneksi,"DELETE FROM gejala_pasien");
$text_line=$data;
...
for ($start=0; $start < count($text_line); $start++) {
	...
	$sql="INSERT INTO gejala_pasien (kd_gejala,id_pasien) VALUES ('$baris','$id_aut_pas')";
	$query=mysqli_query($koneksi, $sql) or die(mysqli_error());
	$posisi++;
print $text_line[$start] . "<BR>";
}
ob_start();
echo "<meta http-equiv='refresh' content='0; url=hasil_diagnosa.php'>";
?>
